			...
			if(IsSet($_SESSION["user_id"])) {				
					...
					echo "<tr align='center'> <td colspan='5'> Failed to connect to MySQL </td> </tr>";
						...
						if($f==1) {
							...
							$walla1=MySQLi_Query($res_id,$query);
							
							$count=MySQLi_Query($res_id,"select (max(id)+1) as count  from are_friends");
							...
							$walla=MySQLi_Query($res_id,$query1);
							$walla=MySQLi_Query($res_id,$query2);
